...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		void Start()
		{
            ...
            //img = GameObject.Find("WinnerImage").GetComponent<Image>();
        ...
        void SetCountText()
        {
            ...
            if (count >= 12)
            {
                // img.sprite = Resources.Load<Sprite>("C:/Users/Lizbeth/Documents/Laberito_unity-chan/Assets/Standard Assets/CrossPlatformInput/Sprites/Unity_chann");
